...
func (logger *Logger) Tracef(format string, v ...interface{}) {
	if logger.GetLevel().Enabled(TraceLevel) {
...
func (logger *Logger) Debugf(format string, v ...interface{}) {
	if logger.GetLevel().Enabled(DebugLevel) {
...
func (logger *Logger) Infof(format string, v ...interface{}) {
	if logger.GetLevel().Enabled(InfoLevel) {
...
func (logger *Logger) Warningf(format string, v ...interface{}) {
	if logger.GetLevel().Enabled(WarningLevel) {
...
func (logger *Logger) Errorf(format string, v ...interface{}) {
	if logger.GetLevel().Enabled(ErrorLevel) {
...
func (logger *Logger) Panicf(format string, v ...interface{}) {
	...
	if logger.GetLevel().Enabled(PanicLevel) {
...
func (logger *Logger) Fatalf(format string, v ...interface{}) {
	if logger.GetLevel().Enabled(FatalLevel) {
